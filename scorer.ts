...
export class Scorer {
    ...
    private listOfBatsman: Array<Batsman>;
    private totalScore: number;
    private ballCount : number = 0;
    private overCount : number = 0;
    private numberOfOvers: number = 0;
    private bowlerObject: Bowler | null;
    private listOfBowler: Array<Bowler>;
    private totalBallsBowled: number = 0;
...
addBatsman(batsmanName: Batsman) {
    this.listOfBatsman.push(batsmanName);
}

addBowler(bowlerName: Bowler) {
